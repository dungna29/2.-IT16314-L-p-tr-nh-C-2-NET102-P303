    ...
    class ServiceAll
    {
        ...
        public List<SanPham> GetListSanPhams()
        {
            return new List<SanPham>
            {
                ...
                new SanPham{Id = 8,MaSP = "SP8",TenSP = "Iphone 8",MauSac = "Đen",TrongLuong = 800,KickThuoc = 8,GiaNhap = 9000000,GiaBan = 18000000,NgayTao = new DateTime(2021, 10, 5),TrangThai = false,MoTa = null,IdTheLoai = 2,IdNhanVien = 3},
